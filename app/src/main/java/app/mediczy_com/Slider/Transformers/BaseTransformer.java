package app.mediczy_com.Slider.Transformers;
...
public abstract class BaseTransformer implements ViewPagerEx.PageTransformer {
    ...
    /**
     * If the position offset of a fragment is less than negative chat_bot_one or greater than chat_bot_one, returning true will set the
