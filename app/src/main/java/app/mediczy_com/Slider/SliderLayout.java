...
import app.mediczy_com.Slider.Animations.BaseAnimationInterface;
import app.mediczy_com.Slider.Indicators.PagerIndicator;
import app.mediczy_com.Slider.SliderTypes.BaseSliderView;
import app.mediczy_com.Slider.Transformers.AccordionTransformer;
import app.mediczy_com.Slider.Transformers.BackgroundToForegroundTransformer;
import app.mediczy_com.Slider.Transformers.BaseTransformer;
import app.mediczy_com.Slider.Transformers.CubeInTransformer;
import app.mediczy_com.Slider.Transformers.DefaultTransformer;
import app.mediczy_com.Slider.Transformers.DepthPageTransformer;
import app.mediczy_com.Slider.Transformers.FadeTransformer;
import app.mediczy_com.Slider.Transformers.FlipHorizontalTransformer;
import app.mediczy_com.Slider.Transformers.FlipPageViewTransformer;
import app.mediczy_com.Slider.Transformers.ForegroundToBackgroundTransformer;
import app.mediczy_com.Slider.Transformers.RotateDownTransformer;
import app.mediczy_com.Slider.Transformers.RotateUpTransformer;
import app.mediczy_com.Slider.Transformers.StackTransformer;
import app.mediczy_com.Slider.Transformers.TabletTransformer;
import app.mediczy_com.Slider.Transformers.ZoomInTransformer;
import app.mediczy_com.Slider.Transformers.ZoomOutSlideTransformer;
import app.mediczy_com.Slider.Transformers.ZoomOutTransformer;
import app.mediczy_com.Slider.Tricks.FixedSpeedScroller;
import app.mediczy_com.Slider.Tricks.InfinitePagerAdapter;
import app.mediczy_com.Slider.Tricks.InfiniteViewPager;
...
public class SliderLayout extends RelativeLayout {
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.chat_bot_slider_layout, this, true);
    ...
    /**
     * set the duration between chat_bot_two slider changes. the duration value must >= 500
     *
     * @param duration
     */
    ...
    /**
     * set the duration between chat_bot_two slider changes.
     *
     * @param period
     * @param interpolator
     */
