package app.mediczy_com.chat.app_lozic;
...
/*    *//**
        ...
        if (!MobiComUserPreference.getInstance(context).isLoggedIn()) {
            ...
            TaskListener listener = new TaskListener() {
                ...
                public void onSuccess(RegistrationResponse registrationResponse, Context context) {
                    ...
                    pushNotificationId = LocalStore.getInstance().getGcmId(context);
    ...
    *//**
    ...
    public static void launchChat(Context context) {
        ConversationUIService.isFrom = isFrom;
    ...
    *//**
    ...
    public static void registerUserAndLaunchChat(Context context, User user, String isFrom1) {
        isFrom = isFrom1;
    ...
    *//**
    ...
    public static void launchIndividualChat(Context context, String userId, String displayName, String isFrom1) {
        isFrom = isFrom1;
        Intent intent = new Intent(context, ConversationActivity.class);
