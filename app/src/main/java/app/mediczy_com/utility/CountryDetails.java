...
public class CountryDetails {
    ...
    public static String[] country = new String[]
            ...
            {"India", "Afghanistan", "Algeria", "Angola", "Argentina", "Australia", "Austria", "Azerbaijan",

                    "Bangladesh", "Belarus", "Belgium", "Bolivia", "Bosnia and Herzegovina", "Brazil", "Bulgaria", "Cameroon", "Canada", "Chile",

                    "China", "Colombia", "Costa Rica", "Croatia", "Cuba", "Czech Republic", "Denmark", "Dominican Republic", "Ecuador", "Egypt",

                    "El Salvador", "Ethiopia", "Finland", "France", "Germany", "Ghana", "Greece", "Guatemala", "Hong Kong", "Hungary",

                    "Indonesia", "Iran", "Iraq", "Ireland", "Israel", "Italy", "Japan", "Jordan", "Kazakhstan",

                    "Kenya", "Kuwait", "Lebanon", "Malaysia", "Mexico", "Morocco", "Nepal", "Netherlands", "New Zealand", "Nigeria",

                    "Norway", "Oman", "Pakistan", "Paraguay", "Peru", "Philippines", "Poland", "Portugal", "Puerto Rico", "Romania",

                    "Russia", "Saudi Arabia", "Senegal", "Serbia", "Singapore", "Slovakia", "South Africa", "South Korea", "Spain", "Sri Lanka",

                    "Sudan", "Sweden", "Switzerland", "Syria", "Tanzania", "Thailand", "Tunisia", "Turkey", "Uganda", "Ukraine",

                    "United Arab Emirates", "Uruguay", "Uzbekistan", "Venezuela", "Yemen", "Zambia", "Zimbabwe"};

    public static String[] code = new String[]
            { "+91", "+93", "+213", "+244", "+54", "+61", "+43", "+994", "+880", "+375", "+32", "+591", "+387", "+55", "+359", "+237", "+1",

                    "+56", "+86", "+57", "+506", "+385", "+53", "+420", "+45", "+1-809", "+593", "+20", "+503", "+251", "+358", "+33", "+49",

                    "+233", "+30", "+502", "+852", "+36", "+62", "+98", "+964", "+353", "+972", "+39", "+81", "+962", "+7", "+254",

                    "+965", "+961", "+60", "+52", "+212", "+977", "+31", "+64", "+234", "+47", "+968", "+92", "+595", "+51", "+63", "+48",

                    "+351", "+1-787", "+40", "+7", "+966", "+221", "+381", "+65", "+421", "+27", "+82", "+34", "+94", "+249", "+46", "+41",

                    "+963", "+255", "+66", "+216", "+90", "+256", "+380", "+971", "+598", "+998", "+58", "+967", "+260", "+263"};
